...
def get_query_engine():
    ...
    if os.path.exists(persist_dir):
        ...
        st.warning("🛠️ 인덱스가 없어 새로 생성 중입니다. 시간이 오래 걸려요")
        docs = load_docs_from_excel("final_data.xlsx")
    ...
    llm = LlamaOpenAI(
        ...
        system_prompt=(
            ...
            "효능효과 : XXX\n\n"
            "그 다음 줄에 다음 지침을 따릅니다:\n"
            "약에 대한 설명은 충분히 길고 친절하게 해주시고, 사용자에게 도움이 될 수 있도록 실제 상황을 가정하여 사용 방법, 부작용, 주의사항 등을 구체적으로 알려주세요.\n"
        )
    )
    Settings.llm = llm
